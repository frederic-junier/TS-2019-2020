...
\title[exponentielle]{Exemples du cours sur les complexes Partie 2 2019/2020}
%\subtitle{Sous titre}
...
\begin{frame}
\frametitle{Exemple 7 : Question 1}
\label{exemple7}

Dans le plan complexe muni d'un repère orthonormal direct, les points A, B et C ont pour affixes respectives $a = - 4,\: b = 2$ et $c = 4$.
...
On a $\text{j} = -\dfrac{1}{2} + \text{i}\dfrac{\sqrt{3}}{2} = \cos \left( \frac{2\pi}{3}\right) + \ic  \sin \left( \frac{2\pi}{3}\right)$.

On en déduit que la forme exponentielle de $\text{j}$ est $ \text{j} =  \text{e}^{\ic \frac{2\pi}{3}}$.

Il est plus simple ici de mettre en évidence directement le cosinus et le sinus.
\end{frame}


\begin{frame}

\frametitle{Exemple 7 : Question 2}

En déduire les formes algébriques et exponentielles de $a'= \text{j}a$, $b'= \text{j}b$ et $c'= \text{j}c$, sachant que $ \text{j} = = \text{e}^{\ic \frac{2\pi}{3}}$

\begin{itemize}
\item $a' = -4\text{e}^{\ic \frac{2\pi}{3}}= 4 \text{e}^{\ic\pi}\text{e}^{\ic \frac{2\pi}{3}} = 4 \text{e}^{\ic \frac{5\pi}{3}}$ sous forme exponentielle et $a' = 2 - 2\ic \sqrt{3}$ sous forme algébrique.

\bcattention{} Dans une forme exponentielle, le coefficient multipliant $\cos(\theta) + \ic \sin(\theta)$ doit être positif. S'il est négatif, il faut écrire $-1=\text{e}^{\ic \pi}$ et un argument est $\theta + \pi$.

\item $b'=  2 \text{e}^{\ic \frac{2\pi}{3}}$ sous forme exponentielle et $b' = -1  + \ic \sqrt{3}$ sous forme algébrique.
\item $c'= 4 \text{e}^{\ic \frac{2\pi}{3}}$ sous forme exponentielle et $c' = 2 + 2\ic \sqrt{3}$ sous forme algébrique.
...
\frametitle{Exemple 8 : Question 1 (source : APMEP)}
...
\frametitle{Exemple 8 : Question 2 (source : APMEP)}


On a : $\big|z_1\big|= \sqrt{1^2 + (-1)^2} = \sqrt{2}$ et $\big|z_2\big|= \sqrt{4 \times 8^2} = 16$ (en réutilisant ce que l'on avait déjà calculé à la question \textbf{1.}).
...
\frametitle{Exemple 8 : Question 3 (source : APMEP)}
 $Z$ sous forme exponentielle donne : $Z = \dfrac{\sqrt{2}\e^{-\i\frac{\pi}{4}}}{16\e^{-\i\frac{2\pi}{3}}} = \dfrac{\sqrt{2}}{16} \e^{-\i\frac{\pi}{4} - \i\frac{-2\pi}{3}} = \dfrac{\sqrt{2}}{16} \e^{\i\frac{-3\pi}{12} + \i\frac{8\pi}{12}}$
...
\frametitle{Exemple 8 : Question 4 (source : APMEP)}

On en déduit que $\cos \left( \dfrac{5\pi}{12} \right) = \dfrac{\mathcal{R}\!e(Z)}{\big|Z \big|} = \dfrac{\dfrac{-1+\sqrt{3}}{32}}{\dfrac{\sqrt{2}}{16}} = \dfrac{-1 + \sqrt{3}}{32} \times \dfrac{16}{\sqrt{2} } = \dfrac{-1 + \sqrt{3}}{2 \times \sqrt{2}} $
...
\frametitle{Exemple 8 : Question 5 (source : APMEP)}

On va nommer $(E)$ l'équation à résoudre : 
...
\begin{tabular}{@{}l@{$~\iff~$}l}
	...
	&$\cos\left( \dfrac{5\pi}{12} + x \right) = \cos\left( \dfrac{7\pi}{6}\right) $ 
	
\end{tabular}

en appliquant la formule rappelée dans l'énoncé
...
\frametitle{Exemple 8 : Question 5 (fin, source : APMEP))}
