...
\item Dans le plan muni d'un repère orthonormal \Ouv, déterminer l'ensemble $\Gamma$ des points $M$ de coordonnées $\Coord{x}{y}$ tels  que $Z$ soit un réel pur.
\item Dans le plan muni d'un repère orthonormal \Ouv, déterminer l'ensemble $\Gamma$ des points $M$ de coordonnées $\Coord{x}{y}$ tels  que $Z$ soit un imaginaire pur.
