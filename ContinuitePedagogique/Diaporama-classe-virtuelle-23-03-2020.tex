...
\item $\integralex{\pi}{0}{\sin(x)}=\left[-\cos(x)\right]_{\pi}^{0} =-1 - (-(-1)) = -2$ 
\end{itemize}
...
\item $\integralex{\text{e}}{\text{e}^{3}}{\frac{\ln(x)}{x}}=?$
\pause  \item  $\integralex{\text{e}}{\text{e}^{3}}{\frac{\ln(x)}{x}}=\left[\frac{1}{2}(\ln(x))^{2}\right]_{\text{e}}^{\text{e}^{3}}=\frac{1}{2}\left(3^{2}-1\right)=4$

\item $\integralex{\text{e}}{\text{e}^{3}}{\frac{1}{x(\ln(x)+1)}}=?$
\pause \item $\integralex{\text{e}}{\text{e}^{3}}{\frac{1}{x(\ln(x)+1)}}=\left[\ln(\valabs{\ln(x)+1})\right]_{\text{e}}^{\text{e}^{3}}=\ln(4)-\ln(2)$
\item $\integralex{2}{0}{\frac{\text{e}^{x}}{\sqrt{\text{e}^{x}+1}}}$
\pause \item $\integralex{2}{0}{\frac{\text{e}^{x}}{\sqrt{\text{e}^{x}+1}}}=\left[2\sqrt{\text{e}^{x}+1}\right]_{2}^{0}=2\sqrt{2}-2\sqrt{\text{e}^{2}+1}$
\end{itemize}
