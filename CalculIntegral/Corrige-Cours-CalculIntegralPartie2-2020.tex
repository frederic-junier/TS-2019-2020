...
\title[exponentielle]{Exemples du cours du chapitre calcul intégral Partie 2 2019/2020}
%\subtitle{Sous titre}
...
\begin{itemize}
	...
	\item \hyperlink{exemple2}{Exemple 3}
	\item \hyperlink{exemple2}{Exemple 4}
	\item \hyperlink{exemple2}{Exemple 5}
\end{itemize}
...
\item \textbf{Question 3}  $g(t)=\integralex{0}{t}{v(u)}$ est l'aire du rectangle $EFIJ$ c'est-à-dire $t \times 3 = 3t$.
...
$g$ est une fonction linéaire donc elle est dérivable sur $\Interfo{0}{+\infty}$ et $g'(t)=3$.  On remarque que $g'(t)=v(t)$. On peut l'expliquer en prenant  la limite du taux de variation  $\frac{g(t+h)-g(t)}{h} = \frac{3(t+h)-3t}{h}=3$ quand $h$ tend vers $0$.
 ...
 $g(t)=\integralex{0}{t}{v(u)}$ est une primitive de $v$.
